	...
	public void setData(Object data) {
		...
		if (this.uiFieldDTO.getType().equalsIgnoreCase(RegistrationConstants.SIMPLE_TYPE)) {
			...
			for (String langCode : registrationDTO.getSelectedLanguagesByApplicant()) {
				...
				if (value != null && ("bur".equals(langCode) || "fullName".equalsIgnoreCase(uiFieldDTO.getId())) && !"email".equalsIgnoreCase((uiFieldDTO.getId())) && !"phone".equalsIgnoreCase((uiFieldDTO.getId())) && !"nrcNumberPart".equalsIgnoreCase((uiFieldDTO.getId())) && !"nrcNumber".equalsIgnoreCase((uiFieldDTO.getId())) && !"fatherNrcNumberPart".equalsIgnoreCase((uiFieldDTO.getId())) && !"fatherNrcNumber".equalsIgnoreCase((uiFieldDTO.getId())) && !"motherNrcNumberPart".equalsIgnoreCase((uiFieldDTO.getId())) && !"motherNrcNumber".equalsIgnoreCase((uiFieldDTO.getId()))) {
