			...
			if (value instanceof List) {
				...
				for (Object obj : list) {
					if (obj instanceof SimpleDto) {
						...
						if ((("bur".equals(simple.getLanguage()) ||"fullName".equalsIgnoreCase(key)) && !"email".equalsIgnoreCase(key) && !"phone".equalsIgnoreCase(key) && !"nrcNumberPart".equalsIgnoreCase(key) && !"nrcNumber".equalsIgnoreCase(key)  && !"fatherNrcNumberPart".equalsIgnoreCase(key) && !"fatherNrcNumber".equalsIgnoreCase(key)  && !"motherNrcNumberPart".equalsIgnoreCase(key) && !"motherNrcNumber".equalsIgnoreCase(key)) && simple.getValue() != null && simple.getValue().matches(".*[\\u1000-\\u109F].*")) {
